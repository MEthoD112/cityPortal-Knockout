...
var _knockout = __webpack_require__(59);

var _knockout2 = _interopRequireDefault(_knockout);

var _application = __webpack_require__(121);

var _filtermodal = __webpack_require__(123);
...
var _underscore = __webpack_require__(119);
...
function CityViewModel() {
  var self = this;
  this.mainContainer = (0, _jquery2.default)('#cities');
  this.citiesList = (0, _jquery2.default)('#cities-list');
  this.cityModal = (0, _jquery2.default)('#myModal');
  this.cityModalLabel = (0, _jquery2.default)('#myModalLabel');
  this.errorCity = (0, _jquery2.default)('#city-error');
  this.inputCity = (0, _jquery2.default)('#addnewcity');
  this.inputCountry = (0, _jquery2.default)('#addnewcountry');
  this.saveCity = (0, _jquery2.default)('#save-new-city');
  this.saveArea = (0, _jquery2.default)('#save-area');
  this.areaModal = (0, _jquery2.default)('#areaModal');
  this.areaModalLabel = (0, _jquery2.default)('#myModalLabelForEdit');
  this.errorArea = (0, _jquery2.default)('#area-error');
  this.inputArea = (0, _jquery2.default)('#areaname');
  this.inputDescription = (0, _jquery2.default)('#areadescription');
  ...
  self.initCitiesSearch = function (collection) {
    ...
    collection.forEach(function (item) {
      ...
      _this.citiesList.append(option);
    });
  };
  ...
  self.filterCity = function () {
    ...
    if (!bool) {
      ...
      self.mainContainer.prepend('<h3 class="city-error" id="city-error-main">' + _constants.constants.alertNoCities + '</h3>');
      return;
    }
  ...
  self.addOrEditCity = function (item, event) {
    ...
    if ((0, _jquery2.default)(event.target).attr('data-mode') === 'add') {
      ...
      self.citiesCollection.push(new _citymodel.CityModel(self.createCity()));
    } else {
      ...
      self.citiesCollection()[self.index].isIndustrial((0, _jquery2.default)('#i').attr('data-act'));
      self.citiesCollection()[self.index].isCriminal((0, _jquery2.default)('#c').attr('data-act'));
      self.citiesCollection()[self.index].isPolluted((0, _jquery2.default)('#p').attr('data-act'));
    }
  ...
  self.createArea = function () {
    var model = {
      ...
      description: (0, _jquery2.default)('#areadescription').val(),
      citizenAmount: (0, _jquery2.default)('#areacitizens').val()
    };
    return model;
  };
  ...
  self.output = _knockout2.default.computed(function () {
  ...
  self.deleteArea = function (item, event) {
    ...
    var cityIndex = self.findIndex(cityId);
    var area = self.findArea(cityIndex, areaId);
  ...
  self.openModalForEditCity = function () {
    ...
    self.cityModalLabel.html(_constants.constants.editCity);
    self.errorCity.html('');
    ...
    var isIndustrial = self.citiesCollection()[self.index].isIndustrial();
    var isCriminal = self.citiesCollection()[self.index].isCriminal();
    var isPolluted = self.citiesCollection()[self.index].isPolluted();
    (0, _jquery2.default)('#i').attr('data-act', isIndustrial);
    (0, _jquery2.default)('#c').attr('data-act', isCriminal);
    (0, _jquery2.default)('#p').attr('data-act', isPolluted);

    var iColor = isIndustrial === 'true' ? _constants.constants.activeColor : _constants.constants.noActiveColor;
    var cColor = isCriminal === 'true' ? _constants.constants.activeColor : _constants.constants.noActiveColor;
    var pColor = isPolluted === 'true' ? _constants.constants.activeColor : _constants.constants.noActiveColor;

    (0, _jquery2.default)('#i').css('background', iColor);
    (0, _jquery2.default)('#c').css('background', cColor);
    (0, _jquery2.default)('#p').css('background', pColor);
  ...
  self.openModalForAddingArea = function () {
    ...
    self.areaModalLabel.html(_constants.constants.addArea);
    self.errorArea.html('');
    self.inputArea.val('');
  ...
  self.openModalForEditArea = function (item, event) {
    self.areaId = (0, _jquery2.default)(event.target).attr('data-id');
    self.cityId = (0, _jquery2.default)(event.target).parent().parent().parent().parent().attr('id');
    self.saveArea.attr('data-mode', 'edit');
    self.areaModalLabel.html(_constants.constants.editArea);
    self.errorArea.html('');
    self.indexCity = self.findIndex(self.cityId);
    var area = self.findArea(self.indexCity, self.areaId);
  ...
  self.validateCity = function (mode) {
    if (!self.inputCity.val().trim()) {
      self.errorCity.html(_constants.constants.alertMessageForCity);
      return false;
    }
    if (!self.inputCountry.val().trim()) {
      self.errorCity.html(_constants.constants.alertMessageForCountry);
      return false;
    }
    if (mode === 'edit') {
    ...
    var cities = JSON.parse(_knockout2.default.toJSON(self.citiesCollection()));
    var bool = cities.every(function (item) {
      return item.name.toUpperCase() !== self.inputCity.val().toUpperCase();
    });

    if (!bool) {
      self.errorCity.html(_constants.constants.alertMessageForExistingCity);
      return false;
    }
    return true;
  };
  ...
  self.validateArea = function (mode) {
    if (!self.inputArea.val().trim() || !self.inputDescription.val().trim() || !self.inputCitizenAmount.val().trim()) {
      self.errorArea.html(_constants.constants.alertMessageForAreaFields);
      return false;
    }
    if (!parseInt(self.inputCitizenAmount.val()) || parseInt(self.inputCitizenAmount.val()) < 1) {
      self.errorArea.html(_constants.constants.alertMessageForAreaCitizens);
      return false;
    }
    if (mode === 'edit') {
    ...
    var bool = cities[self.indexCity].cityAreas.every(function (item) {
      return item.name.toUpperCase() !== self.inputArea.val().toUpperCase();
    });
    if (!bool) {
      self.errorArea.html(_constants.constants.alertMessageForExistingArea);
      return false;
    }
    return true;
  };
...
function CityModel(model) {
    ...
    self.formAreasString = _knockout2.default.computed(function () {
        ...
        return arr.length ? arr.join(' ,') : _constants.constants.noAreas;
    });
}
...
var FilterModal = exports.FilterModal = function () {
    function FilterModal() {
        ...
        this.addCityButton = (0, _jquery2.default)('#add-new-city-button');
        this.cityModalLabel = (0, _jquery2.default)('#myModalLabel');
        this.inputCity = (0, _jquery2.default)('#addnewcity');
        this.inputCountry = (0, _jquery2.default)('#addnewcountry');
        this.errorCity = (0, _jquery2.default)('#city-error');
        this.saveCity = (0, _jquery2.default)('#save-new-city');
        this.countriesList = (0, _jquery2.default)('#countries-list');

        // Open modal window for adding city
        this.addCityButton.on('click', function () {
            _this.cityModalLabel.html(_constants.constants.addCity);
            _this.inputCity.val('');
            _this.inputCountry.val('');
            _this.errorCity.html('');
            (0, _jquery2.default)('#i').attr('data-act', 'true');
            (0, _jquery2.default)('#c').attr('data-act', 'false');
            (0, _jquery2.default)('#p').attr('data-act', 'false');
            (0, _jquery2.default)('#i').css('background', _constants.constants.activeColor);
            (0, _jquery2.default)('#c').css('background', _constants.constants.noActiveColor);
            (0, _jquery2.default)('#p').css('background', _constants.constants.noActiveColor);
            _this.saveCity.attr('data-mode', 'add');
        });
    ...
    _createClass(FilterModal, [{
        ...
        value: function initCountriesList(collection) {
            var _this2 = this;
            ...
            collection.forEach(function (item) {
                if (arr.indexOf(item.country) === -1) {
                    ...
                    _this2.countriesList.append(option);
                }
            });
        }
    }]);
